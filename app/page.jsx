...
const Home = () => {
  return 
  //   <div className='w-full md:w-2/3 lg:w-3/4 mx-auto px-4 md:px-0 text-white'
  //        style={{ fontFamily: 'var(--font-raleway)' }}>
  //     <div className='my-8 ml-[-8]'>
  //       <div className='hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-xl md:text-2xl' style={{ fontFamily: 'var(--font-permanent-marker)' }}>
  //         <p>ZERTTE<span className='text-[#38B000]'>SH</span></p>
  //         <p className='mt-[-11px] h-[13px] w-350 text-base font-[400]'>VISIT & EXPLORE</p>
  //       </div>

  //       <h1 className='text-xl md:text-4xl lg:text-5xl mt-4 absolute top-[98px] text-left font-[400] text-[#38B000]' style={{ fontFamily: 'var(--font-permanent-marker)' }}>
  //         <Balancer>
  ...
  //       <a href='https://twitter.com/Tubussines69/status/1682683077695270913?s=20' target='_blank' className='block mt-4'>
  //         <div className='p-4 items-center justify-between flex-col mt-80 flex h-60 md:h-[70px] w-[800px] sm:w-[250px] gap-0 rounded-[78px] bg-[#84D1FD] px-[55px] py-[17px] font-[500] text-[#1DA1F3] text-center sm:text-left'>
  //           <span className='text-xl md:text-2xl'>Introducing Zerttesh</span>
  //           <img src='/twitter.png' alt='twitter11111' className='h-8 md:h-10' />
  //         </div>
  //       </a>

  //       <h1 className='text-xl md:text-4xl lg:text-5xl mt-8' style={{ fontFamily: 'var(--font-permanent-marker)' }}>
  ...
  //       <div className='my-8'>
  //         <img src='/mausoleum.jpg' alt='mausoleum1115' className='w-full h-auto' />
  ...
  //       <div className='my-8'>
  //         <img src='/aishabibi.jpg' alt='aishabibi1116' className='w-full h-auto' />
  ...
  //       <div className='my-8'>
  //         <h1 className='text-xl md:text-4xl lg:text-5xl' style={{ fontFamily: 'var(--font-permanent-marker)' }}>Visit, See, Explore</h1>
  ...
  //       <footer className="py-8 px-8 flex items-center md:flex-row justify-between font-raleway mt-4 md:mt-8 h-[35px] w-full bg-[#3E3E3E] pb-[40px] pl-[9px] pr-[22px] pt-[11px] text-left font-[400]">
  //         <p className="text-sm md:text-base">
  //           Zerttesh, Kazakhstan, Aqtau 2023
  //         </p>
  //         <div className="mt-4 md:mt-0">
  //           <a href="https://www.linkedin.com/in/nargiza-nurmukhan-7292aktausila/" target="_blank" className="mx-2">
  //             <img src="/linkedin.png" alt="linkedin1136" className="h-6 w-6 md:h-8 md:w-8" />
  //           </a>
  //           <a href="https://www.instagram.com/tubusiness._/" target="_blank" className="mx-2">
