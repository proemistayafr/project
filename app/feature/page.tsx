...
<section>
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
      ...
      <a className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-white  dark:border-blue-400 dark:hover:bg-blue-400">
    ...
    {locationText &&  <p className="font-normal text-gray-500 dark:text-gray-400">{locationText}</p>}
        ...
        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img src="/kzz.png" alt="mockup" width={2000} height={2000}/>
        </div>                
    </div>
</section>
   </div>
