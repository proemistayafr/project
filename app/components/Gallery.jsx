...
<figure class="max-w-lg">
  ...
  <figcaption class="mt-2 text-sm text-left text-[#9EF01A]">   The construction of the mausoleum began in 1389, several centuries
...
<figure class="max-w-lg mt-10">
  ...
  <figcaption class="mt-2 text-sm text-left text-[#9EF01A]">   A historical mausoleum located in the southern region of Kazakhstan.
